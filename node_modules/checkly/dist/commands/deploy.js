...
class Deploy extends authCommand_1.AuthCommand {
    async run() {
        ...
        const project = await (0, project_parser_1.parseProject)({
            ...
            multiStepCheckMatch: (_e = (_d = checklyConfig.checks) === null || _d === void 0 ? void 0 : _d.multiStepChecks) === null || _e === void 0 ? void 0 : _e.testMatch,
        ...
        try {
            ...
            if (!preview) {
                ...
                const heartbeatCheckIds = data.diff.filter((check) => heartbeatLogicalIds.includes(check.logicalId))
                    .map(check => check === null || check === void 0 ? void 0 : check.physicalId);
            ...
            if (((_h = err === null || err === void 0 ? void 0 : err.response) === null || _h === void 0 ? void 0 : _h.status) === 400) {
                throw new Error(`Failed to deploy your project due to wrong configuration. ${(_j = err.response.data) === null || _j === void 0 ? void 0 : _j.message}`);
            }
            else {
