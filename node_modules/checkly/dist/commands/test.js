...
class Test extends authCommand_1.AuthCommand {
    async run() {
        ...
        const { location: runLocation, 'private-location': privateRunLocation, grep, tags: targetTags, env, 'env-file': envFile, list, timeout, verbose: verboseFlag, reporter: reporterFlag, config: configFilename, record: shouldRecord, 'test-session-name': testSessionName, 'update-snapshots': updateSnapshots, retries, } = flags;
        ...
        const project = await (0, project_parser_1.parseProject)({
            ...
            multiStepCheckMatch: (_g = (_f = checklyConfig.checks) === null || _f === void 0 ? void 0 : _f.multiStepChecks) === null || _g === void 0 ? void 0 : _g.testMatch,
            ignoreDirectoriesMatch: (_h = checklyConfig.checks) === null || _h === void 0 ? void 0 : _h.ignoreDirectoriesMatch,
            checkDefaults: checklyConfig.checks,
            browserCheckDefaults: (_j = checklyConfig.checks) === null || _j === void 0 ? void 0 : _j.browserChecks,
        ...
        const checks = Object.entries(project.data.check)
            ...
            .filter(([, check]) => {
            var _a, _b, _c;
            const tags = (_a = check.tags) !== null && _a !== void 0 ? _a : [];
            const checkGroup = this.getCheckGroup(project, check);
            if (checkGroup) {
                const checkGroupTags = (_b = checkGroup.tags) !== null && _b !== void 0 ? _b : [];
                tags.concat(checkGroupTags);
            }
            return (0, test_filters_1.filterByTags)((_c = targetTags === null || targetTags === void 0 ? void 0 : targetTags.map((tags) => tags.split(','))) !== null && _c !== void 0 ? _c : [], tags);
        })
            .map(([key, check]) => {
            var _a;
            check.logicalId = key;
        ...
        const testRetryStrategy = this.prepareTestRetryStrategy(retries, (_k = checklyConfig === null || checklyConfig === void 0 ? void 0 : checklyConfig.cli) === null || _k === void 0 ? void 0 : _k.retries);
