...
class MultiStepCheck extends check_1.Check {
    ...
    constructor(logicalId, props) {
        ...
        if (!((_a = project_1.Session.availableRuntimes[this.runtimeId]) === null || _a === void 0 ? void 0 : _a.multiStepSupport)) {
    ...
    static applyDefaultMultiStepCheckConfig(props) {
        ...
        for (configKey in project_1.Session.multiStepCheckDefaults) {
            const newVal = (_a = props[configKey]) !== null && _a !== void 0 ? _a : project_1.Session.multiStepCheckDefaults[configKey];
            props[configKey] = newVal;
        }
    }
